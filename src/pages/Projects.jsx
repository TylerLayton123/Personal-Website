  ...
  const projects = [
    {
      ...
      description: "\tThis project is unfinished since I am still in school. The idea is to create an application/website" +
        ...
        " generate personalized network visualizations and interact with the network through an intuitive, responsive interface. The primary goal" +
        ...
        " Lastly, I want to implement the ability to export the visual graph as a PDF and the corresponding data as a CSV." +
        " Much more research will need to be done, and I am excited to start working on this project next year." +
        " Some additional features I am considering include tutorial videos, real-time collaboration (though this may prove too complex), and further customization options such as background colors and node shapes." +
    ...
    },
    {
      ...
      description: "\tFor this summer I wanted to make a personal website where I could display my entire academic career and not be limited to " +
        ...
        " I always thought was an interesting theory. This website was made using JavaScript, CSS, Node.js, and React. It is also hosted on a personal sever" +
    ...
    },
    {
      ...
      description: "\tThis is more of a passion project than a serious project. I enjoy playing games and i wanted to see if I could make one." +
        ...
        " land in different planets. This game might never get finished, but I every now and then I will work on it just for fun."
    },
    {
      ...
      " that I could play video games on, but I didnt want to buy a prebuilt one. I felt like I had to build one myself since I am a CS/CSE major."+
      ...
      " too inefficient that it cant run the games I like to play. The process of building it was a very enjoyable. I had to look up what"+
      " certain pins were on the motherboard, carfully install the graphics card, and figure out everything by myself. In the end, I got a great"+
      " final set up that I can take pride in since I made it all myself. Here are the specs: \n\t- Moniter: 3840x2160 pixel @ 165Hz\n\t- Graphics Card:"+
